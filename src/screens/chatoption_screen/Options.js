...
import { StyleSheet, Text, TouchableOpacity, View, TouchableWithoutFeedback, StatusBar } from "react-native";
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <View style={{ marginTop: 10 }}><Text style={{ fontSize: 16, textAlign: 'justify', }}>
               ...
               sent by going to <Text style={{ color: mainStyle.colors.primary, textDecorationLine: 'underline' }}>Google Album Archive Learn more.</Text>
              </Text></View>
          ...
          <View>
            <View style={styles.upperContainer}>
              <View style={styles.headerContainer}>
                <MaterialIcons name="arrow-back" size={25} color="#fff" onPress={() => navigation.goBack()} />
